...
# File to collapse
analysis_output_file <- 'vcf-files/L14_S3_L001_freebayes_ann-lineagespot.tsv'
...
utils::write.csv(lineages_collapsed, 
                 file = stringr::str_replace(analysis_output_file, ".tsv", "-collapsed.csv"), 
                 row.names = FALSE, 
                 quote = FALSE)
